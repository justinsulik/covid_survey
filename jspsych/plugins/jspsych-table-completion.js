...
jsPsych.plugins["table-completion"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      preamble: {
        type: jsPsych.plugins.parameterType.STRING,
        default: "Please write down the first names of all the people with whom you had a conversation in the past 7 days and how you interacted with them. Please do not include casual contacts such as interactions with shop workers or professionals (e.g., doctors, police etc.).",
